...
import com.sesxh.commoncore.store.SPUtils;
...
//    }
    ...
    public static String getDeviceSN() {
        String macAddress = getMacAddressByInetAddress();//先获取网线mac
        if ("02:00:00:00:00:00".equals(macAddress)){
            macAddress = getMacAddressByNetworkInterface();//获取不到在获取WiFi得mac
        }
