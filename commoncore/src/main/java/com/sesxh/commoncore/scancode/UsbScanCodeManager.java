...
public class UsbScanCodeManager extends ScanCodeBase {
    ...
    public UsbScanCodeManager(OnScanValueListener listener) {
     ...
     * 按键对应的char表
     */
    private char keyHealthyValue(boolean caps, int keyCode) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_0:
                return caps ? ')' : '0';
            case KeyEvent.KEYCODE_1:
